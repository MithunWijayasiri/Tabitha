...
<div class="flex min-h-0 flex-col bg-panel-alt {className}">
  {#if hasTabs}
    <div
    ...
    <ul
      bind:this={ulEl}
      class="flex-1 overflow-y-auto pb-4 pl-4"
      style:padding-right="calc(1rem + {scrollBarPadding})"
    >
